window.onload = function() {
	...
	(function loadDefaultObj() {
		...
		loadObj( main_settings.etalon.path, main_settings.main.obj, main_settings.etalon.mtl, true, {x: 0, y:5, z:0}, 5, {x: 0,y:0,z:0}, 'etalon', mainObj );
	...
	function stepFrame() {
		window.requestAnimationFrame(stepFrame,10);
		...
		/*if (mainObj[0]) {
			mainObj[0].rotation.x = -Math.PI / 2;
			mainObj[0].position.set(0, -6, 0);
			...
			_sphere.add();      // add child to parent
			scene.add(_sphere);
					...
					case 'default-input-range':
						...
						for (var el = 0; el <= mainObj[0].children.length; el++) {
							if (static_w.indexOf(mainObj[0].children[el].name) != -1) {
								...
								if ((this.value - 4) / 4.7 < 1) {
									mainObj[0].children[el].scale.y = 1;
									this.value = 1;
								} else {
									mainObj[0].children[el].scale.y = (this.value - 4) / 4.7;
								}
							}
						}
					...
					case 'default-input-range2':
						for (var el = 0; el <= mainObj[0].children.length; el++) {
							if (static_l.indexOf(mainObj[0].children[el].name) != -1) {
								...
								if ((this.value - 4) / 4.9 < 1) {
									mainObj[0].children[el].scale.x = 1;
									this.value = 1;
								} else {
									mainObj[0].children[el].scale.x = (this.value - 4) / 4.9;
								}
							}
						}
						break;	
						...
						for (var el = 0; el <= mainObj[0].children.length; el++) {
							if (static_h.indexOf(mainObj[0].children[el].name) != -1) {
								...
								if ((this.value - 4) / 4 < 1) {
									...
									mainObj[0].children[el].scale.z = (this.value - 4) / 4;
								}
							}
						}
						break;	
